...
namespace terrain{
	...
	* @author Alfred Malone
	* @version 01
	* @date 7/4/2017 Alfred Malone, created class
	*
	* @author Brandon Lim
	* @version 02
	* @date 27/4/2017 Brandon Lim, added scaling factors
	*
	* @author Ben Porter
	* @version 03
	* @date 28/5/2017 Ben Porter, made getHeight public for terrain tracking
	*
	* @author Alfred Malone
	* @version 04
	* @date 31/5/2017 Alfred Malone, added Doxygen comments
	*/
	class Terrain{
	public:
		/**
